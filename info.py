...
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", '-1002689354872')) # admin your channel in stream 
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", '-1002580205471')) # admin your channel in users log 
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7562079827').split()] # 3567788, 678899, 5889467
...
CHANNEL = environ.get('CHANNEL', 'https://t.me/OWUPDATES')
SUPPORT = environ.get('SUPPORT', 'https://t.me/OWUPDATES')
